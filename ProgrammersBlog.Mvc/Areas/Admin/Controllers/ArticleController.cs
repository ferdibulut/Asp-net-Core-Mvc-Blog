    ...
    public class ArticleController : BaseController
    {
        ...
        public async Task<IActionResult> Update(ArticleUpdateViewModel articleUpdateViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                if (articleUpdateViewModel.Thumbnail != null)
                {
                    ...
                    articleUpdateViewModel.Thumbnail = uploadedImageResult.ResultStatus == Shared.Utilities.Results.ComplexTypes.ResultStatus.Success ? uploadedImageResult.Data.FullName : "postImages/defaultThumbnail.jpg";
