        ...
        $(document).on('click', '#btnSave', function (event) {
            ...
            $.post(actionUrl, dataToSend).done(function (data) {
                ...
                <div class="media mb-4">
                    <img class="d-flex mr-3 rounded-circle" src="~/img/userImages//defaultUser.png" alt="">
                    ...
                    toastr.success(`Sayın ${commentAddAjaxModel.CommentDto.Comment.CreatedByName} yorumunuz başarıyla eklenmiştir,Bir örnegi karşınıza gelecek.fakat yorumunuz onaylandıktan sonra görünür olacaktır.`);
